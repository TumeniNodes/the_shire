...
the_shire_doors = {
    ...
    ["hobbit_door_orange_wood"] = {
        description = "Hobbit Door Orange Wood",
        texture = "hobbit_door_orange_wood.png",
        knob_texture = "hobbit_brass.png",
        groups = { choppy = 2, oddly_breakable_by_hand = 2, flammable = 2 },
        sounds = default.node_sound_wood_defaults(),
        sound_open = "hobbit_door_open",
    ...
    ["hobbit_door_red_wood"] = {
        description = "Hobbit Door Red Wood",
        texture = "hobbit_door_red_wood.png",
        knob_texture = "hobbit_brass.png",
        groups = { choppy = 2, oddly_breakable_by_hand = 2, flammable = 2 },
        sounds = default.node_sound_wood_defaults(),
        sound_open = "hobbit_door_open",
    ...
    ["hobbit_door_yellow_wood"] = {
        description = "Hobbit Door Yellow Wood",
        texture = "hobbit_door_yellow_wood.png",
        knob_texture = "hobbit_brass.png",
        groups = { choppy = 2, oddly_breakable_by_hand = 2, flammable = 2 },
        sounds = default.node_sound_wood_defaults(),
        sound_open = "hobbit_door_open",
